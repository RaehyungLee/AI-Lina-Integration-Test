"""Test file 9 with intentional bugs for chunking test."""

import os
import hashlib
from typing import Optional

def authenticate_user_9(username: str, password: str) -> bool:
...
def execute_command_9(cmd: str) -> str:
...
def serialize_data_9(data: any) -> bytes:
    """Bug: Insecure deserialization."""
    import pickle
    # Bug: pickle is unsafe for untrusted data
    return pickle.dumps(data)

def log_sensitive_data_9(user_id: int, password: str, ssn: str):
...
def generate_token_9(user_id: int) -> str:
...
def parse_xml_9(xml_string: str) -> any:
...
def validate_input_9(data: str) -> bool:
...
def create_temp_file_9(content: str) -> str:
...
def encrypt_data_9(data: str, key: str) -> str:
