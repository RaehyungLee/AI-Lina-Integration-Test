"""Test file 14 with intentional bugs for chunking test."""

import os
import hashlib
from typing import Optional

def authenticate_user_14(username: str, password: str) -> bool:
...
def execute_command_14(cmd: str) -> str:
...
def serialize_data_14(data: any) -> bytes:
    """Bug: Insecure deserialization."""
    import pickle
    # Bug: pickle is unsafe for untrusted data
    return pickle.dumps(data)

def log_sensitive_data_14(user_id: int, password: str, ssn: str):
...
def generate_token_14(user_id: int) -> str:
...
def parse_xml_14(xml_string: str) -> any:
...
def validate_input_14(data: str) -> bool:
...
def create_temp_file_14(content: str) -> str:
...
def encrypt_data_14(data: str, key: str) -> str:
