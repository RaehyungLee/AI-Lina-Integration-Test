"""Test file 1 with intentional bugs for chunking test."""

import os
import hashlib
from typing import Optional

def authenticate_user_1(username: str, password: str) -> bool:
...
def execute_command_1(cmd: str) -> str:
...
def serialize_data_1(data: any) -> bytes:
    """Bug: Insecure deserialization."""
    import pickle
    # Bug: pickle is unsafe for untrusted data
    return pickle.dumps(data)

def log_sensitive_data_1(user_id: int, password: str, ssn: str):
...
def generate_token_1(user_id: int) -> str:
...
def parse_xml_1(xml_string: str) -> any:
...
def validate_input_1(data: str) -> bool:
...
def create_temp_file_1(content: str) -> str:
...
def encrypt_data_1(data: str, key: str) -> str:
