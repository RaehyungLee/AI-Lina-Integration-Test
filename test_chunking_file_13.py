"""Test file 13 with intentional bugs for chunking test."""

import os
import hashlib
from typing import Optional

def authenticate_user_13(username: str, password: str) -> bool:
...
def execute_command_13(cmd: str) -> str:
...
def serialize_data_13(data: any) -> bytes:
    """Bug: Insecure deserialization."""
    import pickle
    # Bug: pickle is unsafe for untrusted data
    return pickle.dumps(data)

def log_sensitive_data_13(user_id: int, password: str, ssn: str):
...
def generate_token_13(user_id: int) -> str:
...
def parse_xml_13(xml_string: str) -> any:
...
def validate_input_13(data: str) -> bool:
...
def create_temp_file_13(content: str) -> str:
...
def encrypt_data_13(data: str, key: str) -> str:
